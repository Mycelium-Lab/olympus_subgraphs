...
export function handleTransfer(event: Transfer): void {
    ...
    if(event.params.src==Bytes.fromHexString("0x31F8Cc382c9898b273eff4e0b7626a6987C846E8")){
      ...
      balanceAdded(toDecimal(event.params.wad,18),false,event.block.timestamp,DAI,"0x6B175474E89094C44Da98b954EedeAC495271d0F");
    ...
    { 
      ...
      balanceAdded(toDecimal(event.params.wad,18),true,event.block.timestamp,DAI,"0x6B175474E89094C44Da98b954EedeAC495271d0F");
